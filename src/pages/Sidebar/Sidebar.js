...
import MoreHorixIcon from '@mui/icons-material/MoreHoriz';
...
const Sidebar = ({ handleLogout,user }) => {
    ...
    const userProfilePic = loggedInUser[0]?.profileImage ? loggedInUser[0]?.profileImage : "https://cdn.pixabay.com/photo/2016/08/08/09/17/avathar-1577909_960_720.png"
    ...
    return (
        <div className="sidebar">
            ...
            <CustomeLink to = '/home/messages'>
                <SidebarOptions active Icon = {MailOutlinedIcon} text='Messages'/>
            </CustomeLink>
            ...
            <div className="Profile_info">
                ...
                <Menu id="basic-menu" anchorEl={anchorEl} open={openMenu} onClick={handleClose} onClose={handleClose}>
                    ...
                    <MenuItem onClick={handleLogout}>Log out @likhith</MenuItem>
                </Menu>
            </div>
        </div>
    );
